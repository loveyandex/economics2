...
public class PinstaUser {
    ...
    private HashTags comeFromHashtag;
    private int edge_followed_by;
    private int edge_follow;

    public PinstaUser(String id, String username, String bio, String externalUrl, String fullName, String probablyCity, HashTags comeFromHashtag, int edge_followed_by, int edge_follow) {
        this.id = id;
        ...
        this.comeFromHashtag = comeFromHashtag;
