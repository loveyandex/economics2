            ...
            try {
                ...
                for (int i = nodes.size()-1; i >= 0; i--) {
                    ...
                    for (Node childNode : childNodes) {
                        ...
                        Elements elementsByAttributeStarting = ((Element) childNode).getElementsByAttributeStarting("data-countdown");

                        String countdown = "";
                        if (elementsByAttributeStarting.size()>0)
                            countdown=elementsByAttributeStarting.get(0).attr("data-countdown");
...
//                            "#irstyle #irstylemagazine"+ "\n";
            ...
            System.out.println("---------------------------------sleeeeeeepingggggggggggggggn------------------------------------------");
