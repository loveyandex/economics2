...
public class ForooshSarkhatApplication2 implements CommandLineRunner {


    public static void main(String[] args) {
        SpringApplication.run(ForooshSarkhatApplication2.class, args);
    }
    ...
    public void run(String... args) throws Exception {
        ...
        isin = "IRO1PTEH0001";//IRO1PTEH0001

        String orderCount = "2304";
        String orderPrice = "32320";
